...
+ (LBXScanViewStyle *)buyStyle {
    ...
    //线条上下移动图片
    style.animationImage = [UIImage imageNamed:@"qrcode_scan_light_orange"];
    
    //码框周围4个角的颜色
    style.colorAngle = [UIColor colorWithRed:233./255. green:94./255. blue:20./255. alpha:1.0];
    //矩形框颜色
    style.colorRetangleLine = [UIColor colorWithRed:233./255. green:94./255. blue:20./255. alpha:1.0];
