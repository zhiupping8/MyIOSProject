...
@interface LJLaunchIntroductionView ()<UIScrollViewDelegate>
{
...
@implementation LJLaunchIntroductionView
NSArray *images;
BOOL isScrollOut;//在最后一页再次滑动是否隐藏引导页
CGRect enterBtnFrame;
NSString *enterBtnImage;
static LJLaunchIntroductionView *launch = nil;
NSString *storyboard;
...
//    isScrollOut = YES;
    isScrollOut = NO;
    launch = [[LJLaunchIntroductionView alloc] initWithFrame:CGRectMake(0, 0, kScreen_width, kScreen_height)];
...
//                imageView.userInteractionEnabled = YES;
                ...
                [imageView addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(enterBtnClick)]];
                imageView.userInteractionEnabled = YES;
            }
        }
    }
