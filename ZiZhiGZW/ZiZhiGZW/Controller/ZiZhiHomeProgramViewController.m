//
//  ZiZhiHomeProgramViewController.m
//  ZiZhiGZW
//
...
@interface ZiZhiHomeProgramViewController ()<UIScrollViewDelegate>
...
@implementation ZiZhiHomeProgramViewController
...
- (void)initSegmentedControl {
    ...
    [self.segmentedControl setIndexChangeBlock:^(NSInteger index) {
        if (0 == index) {
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationApply object:nil];
        }else if(1 == index){
    ...
    ZiZhiProgramSignUpDetailViewController *detailViewController = (ZiZhiProgramSignUpDetailViewController *)[Utils getVCFromSB:@"ZiZhiProgramSignUpDetailViewController" storyBoardName:nil];
    [detailViewController setValue:self.programId forKey:@"programId"];
//    detailViewController.view.backgroundColor = [UIColor clearColor];
    detailViewController.view.frame = CGRectMake(self.segmentedScrollView.frame.size.width, 0, self.segmentedScrollView.frame.size.width, self.segmentedScrollView.frame.size.height);
    [self.segmentedScrollView addSubview:detailViewController.view];
