...
@interface ZiZhiHomeVipViewController ()<UIScrollViewDelegate>
@property (nonatomic, strong) UIScrollView *segmentedScrollView;
@property (nonatomic, strong) HMSegmentedControl *segmentedControl;
@property (nonatomic, strong) NSArray *titles;
@end

@implementation ZiZhiHomeVipViewController
...
- (void)initSegmentedControl {
    ...
    ZiZhiApplyVipViewController *vipViewController = (ZiZhiApplyVipViewController *)[Utils getVCFromSB:@"ZiZhiApplyVipViewController" storyBoardName:nil];
    vipViewController.view.frame = CGRectMake(0, 0, self.segmentedScrollView.frame.size.width, self.segmentedScrollView.frame.size.height);
    [self.segmentedScrollView addSubview:vipViewController.view];
